...
"""
GET_ME_USER_DICT = decoder.decode(GET_MET_RAW_RESPONSE, type=dict)
GET_ME_API_RESPONSE = decoder.decode(GET_MET_RAW_RESPONSE, type=APIResponse).to_result()
GET_ME_USER_MODEL = decoder.decode(GET_ME_API_RESPONSE.unwrap(), type=User)


@pytest.mark.asyncio()
@with_mocked_api(GET_MET_RAW_RESPONSE)
